          ...
          <div className={styles.formBodyContainer}>
            ...
            {isSubmitted && (
              <div className={styles.success}>
                <span
                  className={`${styles.successHeader} ${juliusSansOne.className}`}
                >
                  THANK YOU FOR YOUR INQUIRY!
                </span>
                <span className={styles.successBody}>
                  Your submission has been received, and we’ll get back to you
                  shortly. If you have any immediate questions, feel free to
                  contact us directly on the information provided.
                </span>
                <div className={styles.btnContainer}>
                  <Link href="/">
                    <button
                      type="button"
                      className={`${styles.goBackBtn} ${juliusSansOne.className}`}
                    >
                      GO BACK
                    </button>
                  </Link>
                  <Link href="/blogs">
                    <button type="button" className={styles.goToBlogsBtn}>
                      GO TO BLOGS ⟶
                    </button>
                  </Link>
                </div>
